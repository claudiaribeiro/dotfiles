...
### Clone with Git
    ...
    git clone https://github.com/diogomartf/dotfiles.git ~/.dotfiles
...
Alternatively, you can install this into `~/.dotfiles` remotely without Git using curl:
    ...
    bash -c "`curl -fsSL https://raw.github.com/diogomartf/dotfiles/master/remote-install.sh`"

Or, using wget:

    bash -c "`wget -O - --no-check-certificate https://raw.githubusercontent.com/diogomartf/dotfiles/master/remote-install.sh`"
